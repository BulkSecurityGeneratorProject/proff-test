...
var proffApp = angular.module('proffApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'proffAppUtils', 'pascalprecht.translate', 'truncate']);
